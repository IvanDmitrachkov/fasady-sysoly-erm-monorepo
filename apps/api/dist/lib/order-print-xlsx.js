...
function resolveTemplatePath() {
    ...
    throw new Error(`Не найден шаблон печати ${TEMPLATE_FILE}. Ожидается apps/api/templates/ или dist/templates/ после сборки.`);
}
...
export async function buildOrderPrintXlsxBuffer(order) {
...
//# sourceMappingURL=order-print-xlsx.js.map