...
export const orderPrintRoutes = async (app) => {
    app.addHook("preHandler", requireJwt);
    app.get("/orders/:orderId/print.xlsx", { preHandler: [requireRoles(Role.ADMIN, Role.WORKER)] }, async (request, reply) => {
...
//# sourceMappingURL=order-print.js.map